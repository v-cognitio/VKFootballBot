...
public class LeagueInfoGetter {
    ...
    private static String generateLeagueLink(String league) {
        switch (league) {
            case "rfpl"   : return "https://www.livesport.ru/football/rfpl/calendar/";
            case "epl"    : return "https://www.livesport.ru/football/english-premier-league/calendar/";
            case "laliga" : return "https://www.livesport.ru/football/primera-division/calendar/";
            case "bundes" : return "https://www.livesport.ru/football/bundesliga/calendar/";
            case "seriea" : return "https://www.livesport.ru/football/serie-a/calendar/";
            case "ligue1" : return "https://www.livesport.ru/football/ligue-1/calendar/";
            default       : return  null;
        }
    }
